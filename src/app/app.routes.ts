...
export const routes: Routes = [
  { path: '', component: LoginComponent },
  {
    ...
    data: { expectedRoles: ['Admin-Incidents', 'Admins-User', 'SuperAdmin'] },
  },
  {
    path: 'user',
    ...
    canActivate: [MsalGuard, roleGuard],
    data: {
      expectedRoles: ['user', 'Admin-Incidents', 'Admins-User', 'SuperAdmin'],
    },
  },
  {
  ...
  {
    path: 'view-incident',
    component: IncidentVewPageComponent,
    canActivate: [MsalGuard, roleGuard],
    data: {
      expectedRoles: ['user', 'Admin-Incidents', 'Admins-User', 'SuperAdmin'],
    },
  ...
  {
    path: 'edit-incident',
    component: UserEditFormPageComponent,
    canActivate: [MsalGuard, roleGuard],
    data: {
      expectedRoles: ['user', 'Admins-User', 'Admin-Incidents', 'SuperAdmin'],
    },
  },
  {
    path: 'usermanage',
    ...
    canActivate: [MsalGuard, roleGuard],
    data: { expectedRoles: ['Admins-User', 'SuperAdmin'] },
  },
];
