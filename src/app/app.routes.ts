...
import { IncidentViewFormComponent } from './components/incident-view-form/incident-view-form.component';
...
export const routes: Routes = [
  ...
  { path: 'view-incident', component: IncidentViewFormComponent },
